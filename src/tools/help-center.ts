    ...
    },
    {
      ...
      handler: async () => {
        ...
        const note = truncated
          ...
          : pagesScanned > 1
            ? `\n\n_Note: this scan cost ${cost}; the result is cached briefly per session, so avoid calling it again right away._`
            : '';
        return {
